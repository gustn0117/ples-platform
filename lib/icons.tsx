// SVG icon helpers mapped by genre/category

export function ArtistIcon({ genre, className = 'w-6 h-6' }: { genre: string; className?: string }) {
  switch (genre) {
    case '보컬':
    case '발라드':
      return (
...
export function ArtworkIcon({ category, className = 'w-6 h-6' }: { category: string; className?: string }) {
  switch (category) {
    case '포스터':
      return (
        <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function FilmIcon({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
