            ...
            {tab === 'login' && (
              <form onSubmit={handleLogin} className="flex flex-col gap-0">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="group w-full py-4 mt-7 bg-gray-900 text-white text-base font-semibold rounded-2xl hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 hover:shadow-lg hover:shadow-gray-900/10 hover:-translate-y-px flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
