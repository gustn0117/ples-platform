          ...
          <div className="hidden md:flex items-center gap-3">
            {loading ? (
              ...
              <>
                ...
                <Link
                  href="/points"
                  className="group/pts flex items-center gap-2 rounded-full bg-gradient-to-r from-gray-50 to-gray-100/80 border border-gray-200/60 px-4 py-2 text-sm font-semibold text-gray-700 transition-all duration-300 hover:border-gray-300 hover:shadow-sm hover:shadow-black/5"
                  style={{ transitionTimingFunction: 'cubic-bezier(0.16, 1, 0.3, 1)' }}
                >
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-gray-900 text-[9px] font-bold text-white group-hover/pts:scale-110 transition-transform duration-300">
                    P
                  </span>
                  ...
                  {dropdownOpen && (
                    <div className="absolute right-0 mt-2.5 w-56 origin-top-right rounded-xl border border-gray-100 bg-white shadow-lg shadow-black/5 animate-fadeIn">
                      ...
                      <div className="py-1.5">
                        ...
                        >
                          <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-gray-100 text-gray-500 group-hover/item:bg-gray-200 group-hover/item:text-gray-700 transition-colors duration-200">
                      ...
                      <div className="border-t border-gray-100 py-1.5">
                        ...
                        >
                          <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-transparent text-gray-400 group-hover/item:bg-gray-100 group-hover/item:text-gray-500 transition-colors duration-200">
                            <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <Link
                  ...
                  className="relative rounded-xl bg-gray-900 px-6 py-2.5 text-sm font-medium text-white transition-all duration-300 hover:bg-black hover:shadow-lg hover:shadow-black/15 hover:-translate-y-px group overflow-hidden"
                  style={{ transitionTimingFunction: 'cubic-bezier(0.16, 1, 0.3, 1)' }}
                >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-1">
                  <span className="flex h-4 w-4 items-center justify-center rounded-full bg-gray-900 text-[7px] font-bold text-white">P</span>
        ...
        <div className="absolute bottom-0 left-0 right-0 border-t border-gray-100 bg-gray-50/50">
          {user && profile ? (
            ...
            <div className="p-4 space-y-2.5">
              <Link
                href="/login?tab=signup"
                className="relative flex items-center justify-center gap-2 w-full rounded-xl bg-gray-900 px-4 py-3 text-sm font-semibold text-white hover:bg-black transition-all duration-300 overflow-hidden group"
              >
                <span className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/10 to-white/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <span className="relative">시작하기</span>
                <svg className="relative w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
              </Link>
              <Link
